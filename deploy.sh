...
kubectl set image deployments/client-deployment client=luisalen/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=luisalen/multi-worker:$SHA
